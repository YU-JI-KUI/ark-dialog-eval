...
from app.core.eval.metrics import binary_report
from app.core.eval.pipeline import build_all_samples, detect_gold, load_and_prep
from app.core.llm.judge_runner import active_backend, generate_advice, judge_batch
